"""
Refactored main entry point for GitHub Tracker.
"""

import sys
import logging
from .config.settings import Settings
from .core.tracker_refactored import GitHubTracker
...
def main():
    ...
    logger.info("Starting GitHub Statistics Tracker for Obsidian (Refactored)")
    print("🚀 GitHub Statistics Tracker for Obsidian (Refactored)")
    print("=" * 60)
